<html lang="">
	<head>
        ...
        <title>Quản lý cửa hàng Siêu thị Thiên Nhiên</title>
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#337ab7">Siêu thị Thiên Nhiên</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2022 <a href="#" style="color:red">Siêu thị Thiên Nhiên</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
