        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url() ?>admin/content">
                    <i class="glyphicon glyphicon-list"></i><span>Quản lý tin tức</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo base_url()?>admin/product">
                    <i class="fa fa-leaf"></i><span>Quản lý sản phẩm</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo base_url()?>admin/category">
                    <i class="fa fa-indent"></i><span>Quản lý danh mục </span>
                </a>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
                <a href="<?php echo base_url() ?>admin/coupon">
                    <i class="fa fa-diamond"></i> <span>Quản lý mã giảm giá</span>
                </a>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
             <a href="<?php echo base_url() ?>admin/sliders">
                <i class="fa fa-cogs"></i> <span>Quản lý giao diện</span>
            </a>
        </li>
        <li class="treeview">
             <a href="<?php echo base_url() ?>admin/useradmin">
                <i class="fa fa-cogs"></i> <span>Quản lý nhân viên</span>
            </a>
        </li>
