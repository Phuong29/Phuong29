    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> 0241.366.244
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> Sieuthithiennhien.vn@gmail.com
        </div>
      </div>
       ...
       <div class="cart_header">
        <a href="gio-hang" title="Giỏ hàng">
         <span class="cart_header_icon">
          <img style = "width: 30px" src="<?php echo base_url() ?>public/images/cart2.png" alt="Cart">
        </span>
        <span class="box_text">
   ...
   <div class="user_login">
     <a href="thong-tin-khach-hang" title="Tài khoản">
      <div class="user_login_icon">
       <img style ="width: 30px" src="<?php echo base_url() ?>public/images/user.png" alt="Cart">
     </div>
     <div class="box_text">
