...
<div class="container" style="margin-top: 20px ; width: 1290px">
    <div class="sale-title">
        <span>SẢN PHẨM KHUYẾN MÃI </span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px; width:1290px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #0f9ed8; margin-top: 30px">
        <?php 
                ...
                <div class="products-sale">
                    <div class="lt-product-group-image">
                        <a href="<?php echo $row['alias'] ?>" title="<?php echo $row['name'] ?>" >
                            <img class="img-p"src="public/images/products/<?php echo $row['img'] ?>" alt="">
                        </a>
                        ...
                        <?php foreach ($listProducts as $sp) :?>
                            <div class="p-box-5">
                                <div class="product-lt">
                                    <div class="lt-product-group-image">
                                        <a href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>"  style = "text-transform: uppercase; fornt-size: 20px;">
...
<div class="container" style=" width: 100%; heigh: 500px; margin-top: 50px">
                        ...
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                ...
                                <span class="small-text">
                                    Cung cấp tất cả các loại tinh bột, thảo dược, bột trà xanh, mầm đậu nành...
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                ...
                                <span class="small-text">
                                    Giao hàng 24h trong nội thành và giao hàng qua bưu điện ở tỉnh khác...
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                ...
                                <span class="small-text">
                                   Thành lập hơn 8 Năm,, phục vụ hơn 500.000 khách hàng trên cả nước
                                </span>
                            </div>
                        </div>
                    </div>
