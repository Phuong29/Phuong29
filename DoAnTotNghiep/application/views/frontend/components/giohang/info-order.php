                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                        ...
                                                        <?php if($value> $row['number']):	?>
                                                            <p >nhập nhỏ hơn <?php echo $row['number'] ?></p>
                                                        <?php endif?>
                                                    </td>
                                        <td>
                                            <?php
...
<div class="btn-checkout frame-100-1 overflow-hidden border-pri">
                        <?php if($value > $row['number']):	?>
                            <p >Không thể tiếp tục vì đặt quá số lượng</p>
                            <br>
                            <a onclick="window.history.go(-1);" class="fa fa-undo undo">Nhấn tại đây để thay đổi số lượng sản phẩm</a>
                        <?php else:?>
