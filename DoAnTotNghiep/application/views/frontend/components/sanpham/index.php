	...
	<div class="banner-product">
		<div class="container" style=" width: 1290px">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<img src="public/images/slides.jpg">
			</div>
		</div>
	</div>
	<div class="slider">
                        ...
                        <?php if(count($list)==0): ?>
                            ...
                            <?php else : ?>
                                <?php foreach ($list as $sp) :?>
                                    <div class="col-md-3 col-lg-3 col-xs-6 col-6" style = "width:300px">
                                        <div class="product-lt">
                                            <div class="lt-product-group-image">
                                                <a style = "width:100%" href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>" >
                                            ...
                                            <div class="lt-product-group-info">
                                                <a style = "text-align:center;" href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>">
                                                    <h3><?php echo $sp['name'] ?></h3>
                                                </a>
                                                <div class="price-box" style = "margin: 5px 59px;">
                                                    <?php if($sp['sale'] > 0) :?>
