		...
		<div class="products-wrap">
			<form action="" method="post" id="ProductDetailsForm">
				<?php if($row):?>
						...
						<div class="product-view-content">
							...
							<div class="actions-qty">
								...
								if($row['number'] - $row['number_buy']==0 || $row['status'] == 0){
									...
									<button class="button btn-cart add_to_cart_detail detail-button" title="Mua ngay" type="button" aria-label="Thêm vào giỏ hàng" class="fa fa-shopping-cart" onclick="onAddCart('.$row['id'].')"> Thêm vào giỏ hàng</button>
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit">CHÍNH SÁCH</p>
									<div class="fk-main">
										<div class="fk-sales">
											<!-- </ul>
											<ul>
											<i class="fa fa-map-marker"></i>
												<li>Bảo hành máy khuếch tán lên đến 18 tháng</li>
											</ul>
											<ul>
												<li>1 đổi 1 trong vòng 30 ngày nếu có lỗi do nhà sản xuất <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Cam kết tinh dầu thiên nhiên nguyên chất 100%</li>
											</ul> -->
											<ul class="list-unstyled">
                    <li class="clearfix">
                        <i class="fa fa-taxi"></i>
                        <span>Bảo hành máy khuếch tán lên đến 18 tháng</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-cubes"></i>
                        <span> 1 đổi 1 trong vòng 30 ngày nếu có lỗi do nhà sản xuất</span>
                    </li>
					<li class="clearfix">
                        <i class="fa fa-thumbs-up"></i>
                        <span> Cam kết tinh dầu thiên nhiên nguyên chất 100%</span>
                    </li>
					...
					<div class="product-v-desc col-md-10 col-12 col-xs-12" style="border: 1px solid #B5B5B5 border-radius: 8px">
											...
											<div class="product-lt">
												<div class="lt-product-group-image">
													<a href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>" >
														<img class="img-p"src="public/images/products/<?php echo $sp['img'] ?>" alt="">
													</a>
