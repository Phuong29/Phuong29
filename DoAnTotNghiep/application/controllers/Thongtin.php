...
class Thongtin extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='Siêu thị Thiên Nhiên - Thông tin tài khoản';
    ...
    public function order(){
        ...
        $this->data['title']='Siêu thị Thiên Nhiên - Chi tiết đơn hàng';  
    ...
    public function reset_password(){
       ...
       $this->data['title']='Siêu thị Thiên Nhiên- Đổi mật khẩu';
