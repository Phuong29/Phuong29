...
class Sanpham extends CI_Controller {
    ...
    public function index(){
        ...
        $this->data['title']='Siêu thị Thiên Nhiên - Tất cả sản phẩm';
    ...
    public function category(){
        ...
        $this->data['title']='Siêu thị Thiên Nhiên - Sản phẩm theo từng danh mục';  
    ...
    public function detail($link){   
        ...
        $this->data['row']=$row;
        $this->data['title']='Siêu thị Thiên Nhiên - '.$row['name'];  
